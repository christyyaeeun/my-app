  ...
  return (
    <div>
      <Container centerContent maxW='container.sm' minH='300px' px='3' color='gray.500' m={ 'auto' }>
        ...
        {/* onChange={ (index) => setFooter(index) } bg={ bg } */ }


        {/* <Container p={ '0' } minH='100vh'> */ }
        <Box bg={ 'transparent' } border={ '.1em' } boxShadow={ 'xl' } borderRadius={ '2xl' } shadow={ 'xl' } >
          ...
          <Box className='footer' onChange={ (index) => setFooter(index) } bg={ footerBg } h={ '30px' } borderTop={ 'none' } borderRadius={ '0px 0px 15px 15px' }
          >       </Box>
        </Box>
      </Container>
      {/* </Container> */ }
