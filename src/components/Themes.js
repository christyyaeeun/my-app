            ...
            <Container maxW='2xl'>
                ...
                <SimpleGrid minChildWidth='200px' spacing='30px'>
                    <div onClick={() => navigate('/communication')}>
                        ...
                        <Center py={6}>
                            <Box maxW={'250px'} w={'full'} bg={useColorModeValue('white', 'gray.100')}
                                boxShadow={'2xl'} rounded={'md'} p={6} overflow={'hidden'}>
                                <Box h={'150px'} bg={'gray.100'} mt={-6} mx={-6} mb={6} pos={'relative'}>
                                    <Image rounded={'lg'}
                                        height={140} width={250} objectFit={'contain'} paddingTop={'1em'}
                                ...
                                <Stack>
                                    ...
                                    <Heading color={useColorModeValue('#738dbb', '#738dbb')}
                        ...
                        <Center py={6}>
                            <Box maxW={'250px'} w={'full'} bg={useColorModeValue('white', '#f2e6f0')} boxShadow={'2xl'} rounded={'md'} p={6} overflow={'hidden'}>
                                <Box h={'150px'} bg={'#f2e6f0'} mt={-6} mx={-6} mb={6} pos={'relative'}>
                                    <Image id="qualityTime" rounded={'lg'} height={155} width={282} objectFit={'contain'}
                                ...
                                <Stack>
                                    ...
                                    <Heading color={useColorModeValue('#d7b3d1', '#d574a3')} fontSize={'1xl'} fontFamily={'body'}>
                                       Love Language
                                    </Heading>
                                    <Text color={'gray.500'}>
                                        Here's some tips
                    ...
                    <div onClick={() => navigate('/conflict')}>
                        <Center py={6}>
                            <Box maxW={'250px'} w={'full'} bg={useColorModeValue('white', '#f9aeaf')} boxShadow={'2xl'} rounded={'md'} p={6} overflow={'hidden'}>
                                <Box h={'150px'} bg={'#f9aeaf'} mt={-6} mx={-6} mb={6} pos={'relative'}>
                                    <Image id="talking" rounded={'lg'} height={150} width={300} objectFit={'contain'} marginLeft={'2.6em'}
                                        src={'https://firebasestorage.googleapis.com/v0/b/olt-react.appspot.com/o/conflict.png?alt=media&token=4a621d25-1388-49c8-a287-2b89beeadf44'}                                    />
                                </Box>
                                <Stack>
                                    <Text color={'gray.500'} textTransform={'uppercase'} fontWeight={700} fontSize={'sm'} >
                                        Theme
...
<div onClick={() => navigate('/growth')}>
<Center py={6}>
    <Box maxW={'250px'} w={'full'} bg={useColorModeValue('white', '#ffefc8')}
        boxShadow={'2xl'} rounded={'md'} p={6} overflow={'hidden'}>
        <Box h={'150px'} bg={'#fff4cb'} mt={-6} mx={-6} mb={6} pos={'relative'}>
